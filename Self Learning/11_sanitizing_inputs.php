...
if (isset($_POST['submit'])) {
  ...
  // INPUT_POST ==> refers to $_POST, second parameter refers to the key.
...
<form action="<?php echo htmlspecialchars(
  ...
  <div>
    <!-- if the user give <script>alert(1)</script> as the name and if we try to display the user content then alert will appear on the window instead of text. hence, these form content needs to be sanitized-->
    <label>Name: </label>
